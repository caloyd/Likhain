                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('applicantPassword') is-invalid @enderror" name="applicantPassword" required autocomplete="new-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="applicantPassword_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
