...
<div class="col-md-12">
    ...
    <form id="updatePasswordForm" action="{{ route('admin.update.password', Auth::user()->id) }}" method="POST">
        @csrf
        ...
        <div class="text-center">
            ...
            <button type="reset" class="btn btn-secondary btn-cancel" id="btnCancelPass">CANCEL</button>
        </div>
        </form>
    </div>
@endsection
