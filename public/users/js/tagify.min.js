...
(function (root, factory) {
    ...
    Tagify.prototype = {
                ...
                for (var key in b) {
                    if (b.hasOwnProperty(key)) {
                        if (that.isObject(b[key])) {
                            if (!that.isObject(a[key])) a[key] = Object.assign({}, b[key]);
        ...
        validateTag: function validateTag(s) {
            ...
            else if (!this.settings.duplicates && this.isTagDuplicate(value)) result = this.TEXTS.duplicate;
        ...
        getMixedTagsAsString: function getMixedTagsAsString() {
            ...
            this.DOM.input.childNodes.forEach(function (node) {
                if (node.nodeType == 1 && node.classList.contains("tagify__tag")) result += _interpolator[0] + JSON.stringify(_this11.value[i++]) + _interpolator[1];
